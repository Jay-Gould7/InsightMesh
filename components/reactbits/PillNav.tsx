...
const PillNav: React.FC<PillNavProps> = ({
  ...
  const isRouterLink = (href?: any) => 
    href && typeof href === 'string' && !isExternalLink(href);
  ...
  return (
    <div className={`relative z-10 w-full md:w-auto ${className}`} style={cssVars}>
      <nav
        className="w-full md:w-max flex items-center justify-between md:justify-start box-border md:px-0"
        aria-label="Primary"
      >
        {logo && (
